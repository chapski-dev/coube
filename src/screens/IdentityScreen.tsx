...
export const IdentityScreen = () => {
  ...
  return (
    <ScrollView style={{ paddingBottom: insets.bottom || 15 }}>
      ...
      <Box px={20} py={10} gap={25} row borderColor={colors.grey} style={{ borderBottomWidth: 1 }}>
        <Box>
      ...
      <Box pt={20} pb={20} alignItems="center">
